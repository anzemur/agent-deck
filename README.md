...
- **Agents in other apps:** Claude sessions running in one of your worktrees from Superset, iTerm, Terminal, Warp, Ghostty or another editor window show on that worktree's card (working / idle / needs approval) with a row under Terminals; clicking it brings that app forward. No duplicate notifications for them.
